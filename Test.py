...
r = requests.get(
    "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=PLNOqW9mLQsEqIs2dMqUkVR7DUARUDDuwA&maxResults=50&key=AIzaSyCdoVRTwGmjcRkai11FtT6onb8G6alUmCA"
)
